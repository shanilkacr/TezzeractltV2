...
export const CallToAction = () => {
  ...
  return (
    <section className="bg-[#121212] flex flex-row text-white bg-[radial-gradient(190%_200%_at_center_30%,#01A6EB_10%,#0060EB_15%,#00398C_25%,#121212_40%)] py-[72px] relative overflow-hidden lg:h-[160vh]">
      ...
      <div className=" absolute w-full left-1/2 top-[100vh] -translate-x-1/2 z-10 mx-auto  flex items-center justify-center">
        <motion.div
          ref={borderdDivRef}
...
AI-driven automations for<br/> everyone.            </h2>
            ...
            <div className="flex justify-center py-10 mt-6">
              <button className="bg-white text-black py-4 px-5 rounded-lg font-medium">
