export const Hero = () => {
  return (
    <div className="bg-gradient-to-b from-black via-[#120d42] to-[#004091] text-white py-[72px] relative overflow-clip">
      <div className="absolute h-[375px] w-[750px] lg:w-[2400px] lg:h-[1200px] rounded-[100%] bg-black left-1/2 -translate-x-1/2 border-[#3F8BEC] bg-[radial-gradient(closest-side,#000_82%,#3F8BEC)] top-[calc(100%-96px)]"></div>
